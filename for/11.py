...
for i in range(temp_cant): #Creamos un ciclo cuyo rango es temp_cant
    ...
    #Se crea unas condiciones las cuales calcularan la temperatura mas alta y baja que escribio o digito el usuario
    if temp > temp_alta:
...
#Finalmente se muestra en la pantalla un mensaje el cual nos dice cuales son la temperatura mas alta y baja que digito el usuario y el promedio de temperatura :)
